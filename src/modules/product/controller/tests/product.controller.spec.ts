...
describe("ProductController", () => {
  describe("findAllAvailableProducts", () => {
    ...
    it("Should return an status 500.", async () => {
      ...
      ).mockRejectedValue(() => Promise.reject("No product was found."));
      await productController.findAllAvailableProducts(req, res);
  ...
  describe("createProduct", () => {
    ...
    it("Should return an status 500.", async () => {
      vi.spyOn(fakeProductService, "createProduct").mockRejectedValue(() =>
        Promise.reject(
          throwError(
  ...
  describe("updateProduct", () => {
    ...
    it("Should return an status 500.", async () => {
      vi.spyOn(fakeProductService, "updateProduct").mockRejectedValue(() =>
        Promise.reject(
          throwError(
  ...
  describe("findById", () => {
    ...
    it("Should return an status 500.", async () => {
      vi.spyOn(fakeProductService, "findById").mockRejectedValue(() =>
        Promise.reject(
