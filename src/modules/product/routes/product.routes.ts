...
productRouter.post("/product/new-product", adminVerificationMiddleware, uploadPhotoMiddleware.single("photo"), productFactory.createProduct.bind(productFactory));
productRouter.patch("/product/update-product/:id", adminVerificationMiddleware, productFactory.updateProduct.bind(productFactory));
